...
var Debug = (function () {
    ...
    Debug.prototype.log = function () {
        ...
        var prefix = new Array(this.level).fill("_").map(function (s, i) { return s + i; }).join("");
        return (_a = window.console.log).bind.apply(_a, __spread([window.console, "%c" + prefix, "color:red;font-weight:bold;"], items));
    };
    Debug.prototype.gb = function (label, isCollapsed) {
        isCollapsed ? console.groupCollapsed(label) : console.group(label);
    };
    Debug.prototype.ge = function () {
        console.groupEnd();
    };
    return Debug;
}());
...
var $ff = "\\runtime-core\\component.ts";
...
var $ff$1 = "\\runtime-core\\renderer.ts";
...
function renderSlot(slots, name, props) {
    if (props === void 0) { props = {}; }
    var slot = slots[name];
    debug.log("\u6E32\u67D3\u63D2\u69FD slot -> " + name)();
    if (slot) {
        return slot(props);
    }
}

export { ITERATE_KEY, computed, createApp, createTextVNode, customRef, effect, enableTracking, getCurrentInstance, h, inject, isProxy, isReactive, isReadonly, isRef, markRaw, pauseTracking, provide, proxyRefs, reactive, readonly, ref, renderSlot, resetTracking, shallowReactive, shallowReadonly, shallowRef, stop, toRaw, toRef, toRefs, track, trigger, triggerRef, unref };
